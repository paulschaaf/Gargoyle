...
interface IStoryXML: IFDBStory {
  ...
  fun with(tag: String, value: String): StoryXML {
    ...
    return StoryXML(newXML)
  }

  fun with(tag: String, value: Any?): StoryXML {
...
open class StoryXML(override val xmlString: String): IStoryXML {
